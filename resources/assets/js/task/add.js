                            ...
                            <div class="p-1">
                                <div x-data="datepicker(${task.id})" x-init="[initDate(), initDatepicker()]">
                                    <div class="text-xs">
                                        ...
                                        <button class="w-full rounded text-left px-3 py-1 hover:bg-gray-100 flex justify-between" type="button" @click="setDateShortcut('tomorrow')">
                                        ...
                                        <button class="w-full rounded text-left px-3 py-1 hover:bg-gray-100 flex justify-between" type="button" @click="setDateShortcut('this_weekend')">
                                        ...
                                        <button class="w-full rounded text-left px-3 py-1 hover:bg-gray-100 flex justify-between" type="button" @click="setDateShortcut('next_week')">

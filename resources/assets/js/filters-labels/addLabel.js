...
function showSavedLabel(label) {
    const savedLabel = document.createElement('a');
    savedLabel.setAttribute('href', `#`);
    savedLabel.setAttribute('class', 'flex justify-between items-center py-2 px-3 border rounded-lg mt-1 group');
    savedLabel.setAttribute('id', `${label.id}`);
    savedLabel.innerHTML +=
        `<div class="flex items-center">
            <svg class="w-6 h-6 mr-1" color="${label.color}" viewBox="0 0 24 24"><path fill="currentColor" d="m5.914 11.086 4.5-4.5A2 2 0 0 1 11.828 6H16a2 2 0 0 1 2 2v4.172a2 2 0 0 1-.586 1.414l-4.5 4.5a2 2 0 0 1-2.828 0l-4.172-4.172a2 2 0 0 1 0-2.828zM14 11a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"></path></svg>
        ...
        <div class="hidden md:flex invisible md:group-hover:visible">
            ...
            <button type="button" class="hover:bg-zinc-100 rounded transition duration-300 flex items-center p-1" title="Delete label"><svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><g fill="none" fill-rule="evenodd"><path d="M0 0h24v24H0z"></path><rect width="14" height="1" x="5" y="6" fill="currentColor" rx="0.5"></rect><path fill="currentColor" d="M10 9h1v8h-1V9zm3 0h1v8h-1V9z"></path><path stroke="currentColor" d="M17.5 6.5h-11V18A1.5 1.5 0 008 19.5h8a1.5 1.5 0 001.5-1.5V6.5zm-9 0h7V5A1.5 1.5 0 0014 3.5h-4A1.5 1.5 0 008.5 5v1.5z"></path></g></svg></button>
        </div>`;

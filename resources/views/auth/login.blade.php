        ...
        <div class="lg:col-start-2 lg:col-end-4">
            ...
            <form action="{{ route('login') }}" method="post" class="grid grid-cols-1 mb-5">
                ...
                <div class="relative mb-4">
                    ...
                    <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Enter your email..." class="rounded-xl border-gray-200 focus:border-gray-400 focus:ring-0 pb-1 pt-8 px-2 w-full h-16 @error('email') border-red-600 focus:ring-red-600 @enderror" autocomplete="off" autofocus>
